...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        navigationBar1.addItem(new ImageIcon(getClass().getResource("/com/raven/icon/cart.png")));
        navigationBar1.addItem(new ImageIcon(getClass().getResource("/com/raven/icon/obat_generik.png")));
        navigationBar1.addItem(new ImageIcon(getClass().getResource("/com/raven/icon/home.png")));
        navigationBar1.addItem(new ImageIcon(getClass().getResource("/com/raven/icon/order.png")));
        navigationBar1.addItem(new ImageIcon(getClass().getResource("/com/raven/icon/info.png")));
        ...
        nb.addColor(4, new Color(51,51,255));
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelTransaction1, javax.swing.GroupLayout.DEFAULT_SIZE, 1483, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(panelTransaction1, javax.swing.GroupLayout.DEFAULT_SIZE, 901, Short.MAX_VALUE)
                .addGap(0, 0, 0)
